...
class AboutDialog(QDialog):
    ...
    def initUI(self):
        ...
        title_label = QLabel("文件层级提取工具")
        title_label.setObjectName("titleLabel")
        title_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(title_label)
        
        version_label = QLabel("版本 v2.4")
        ...
        desc_label = QLabel(
            "<b>软件简介</b><br>"
            "一个简洁高效的文件层级提取工具，<br>"
            "帮助您快速整理和归类各类文件。<br><br>"
            "<b>功能特点</b><br>"
            "✓ 拖拽导入 - 支持同时导入多个源文件夹<br>"
            "✓ 类型筛选 - 按后缀名批量提取特定文件<br>"
            "✓ 层级保持 - 提取后保持原有目录结构<br>"
            "✓ 长路径支持 - 兼容 Windows 超长路径<br>"
            "✓ 智能处理 - 覆盖/共存两种重复文件处理模式"
        )
